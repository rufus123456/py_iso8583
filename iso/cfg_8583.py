...
len_type:
    ...
    LLLVAR_ASC 3位头不压缩
content_type:
    RF_BCD 压缩存储，存储长度是原内容长度/2，右补
    LF_BCD 压缩存储，存储长度是原内容长度/2，左补
    ASCII 原字符存储
    ASCII_HEX 原字符hex展开操作（写入、读出）
    BINARY bit存储
'''

ContentTypes['pos_head'] = {
    -6: {'content_type': 'RF_BCD', 'max_len': 4, 'len_type': 'fixed'},
    -5: {'content_type': 'RF_BCD', 'max_len': 10, 'len_type': 'fixed'},
    -4: {'content_type': 'RF_BCD', 'max_len': 12, 'len_type': 'fixed'},
    -3: {'content_type': 'RF_BCD', 'max_len': 4, 'len_type': 'fixed'},
    -2: {'content_type': 'BINARY', 'max_len': 64, 'len_type': 'BINARY'}
}
...
ContentTypes['pos'] = {
    2: {'content_type': 'RF_BCD', 'max_len': 19, 'len_type': 'LLVAR'},
    3: {'content_type': 'RF_BCD', 'max_len': 6, 'len_type': 'fixed'},
    4: {'content_type': 'RF_BCD', 'max_len': 12, 'len_type': 'fixed'},
    11: {'content_type': 'RF_BCD', 'max_len': 6, 'len_type': 'fixed'},
    12: {'content_type': 'RF_BCD', 'max_len': 6, 'len_type': 'fixed'},
    13: {'content_type': 'RF_BCD', 'max_len': 4, 'len_type': 'fixed'},
    14: {'content_type': 'RF_BCD', 'max_len': 4, 'len_type': 'fixed'},
    15: {'content_type': 'RF_BCD', 'max_len': 4, 'len_type': 'fixed'},
    22: {'content_type': 'RF_BCD', 'max_len': 3, 'len_type': 'fixed'},
    23: {'content_type': 'LF_BCD', 'max_len': 3, 'len_type': 'fixed'},
    25: {'content_type': 'RF_BCD', 'max_len': 2, 'len_type': 'fixed'},
    26: {'content_type': 'RF_BCD', 'max_len': 2, 'len_type': 'fixed'},
    32: {'content_type': 'RF_BCD', 'max_len': 11, 'len_type': 'LLVAR'},
    35: {'content_type': 'RF_BCD', 'max_len': 37, 'len_type': 'LLVAR'},
    36: {'content_type': 'RF_BCD', 'max_len': 104, 'len_type': 'LLLVAR'},
    ...
    48: {'content_type': 'RF_BCD', 'max_len': 322, 'len_type': 'LLLVAR'},
    49: {'content_type': 'ASCII', 'max_len': 3, 'len_type': 'fixed'},
    52: {'content_type': 'RF_BCD', 'max_len': 16, 'len_type': 'fixed'},
    53: {'content_type': 'RF_BCD', 'max_len': 16, 'len_type': 'fixed'},
    54: {'content_type': 'ASCII', 'max_len': 322, 'len_type': 'LLLVAR'},
    55: {'content_type': 'ASCII_HEX', 'max_len': 255, 'len_type': 'LLLVAR'},
    58: {'content_type': 'RF_BCD', 'max_len': 100, 'len_type': 'LLLVAR'},
    59: {'content_type': 'ASCII', 'max_len': 999, 'len_type': 'LLLVAR'},
    60: {'content_type': 'RF_BCD', 'max_len': 17, 'len_type': 'LLLVAR'},
    61: {'content_type': 'RF_BCD', 'max_len': 29, 'len_type': 'LLLVAR'},
    62: {'content_type': 'ASCII', 'max_len': 512, 'len_type': 'LLLVAR'},
    63: {'content_type': 'ASCII', 'max_len': 163, 'len_type': 'LLLVAR'},
    64: {'content_type': 'BINARY', 'max_len': 64, 'len_type': 'BINARY'}
}
...
ContentTypes['yb'] = {
    ...
    49: {'content_type': 'ASCII', 'max_len': 3, 'len_type': 'fixed'},
    52: {'content_type': 'BINARY', 'max_len': 64, 'len_type': 'BINARY'},
...
ContentTypes['lz_term_head'] = {
    -6: {'content_type': 'RF_BCD', 'max_len': 4, 'len_type': 'fixed', 'self_len': 1},
    -4: {'content_type': 'RF_BCD', 'max_len': 20, 'len_type': 'fixed'},
    -2: {'content_type': 'BINARY', 'max_len': 128, 'len_type': 'BINARY', 'bitmap': 1}
}
